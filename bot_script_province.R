...
# tweet ------------------------------------------------------------------------
post_tweet("Fluctuation of fuel prices reported on pumps.ie in #Ireland for the last 30 days. #Petrol #Diesel #FuelPrice", media = "pumps.png", token = bot_token, media_alt_text = "")
